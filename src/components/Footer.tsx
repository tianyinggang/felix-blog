...
const socialLinks = [
  {
    ...
    link: "https://github.com/tianyinggang",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
        className="dark:fill-backgroundLight hover:fill-brandPrimary dark:hover:fill-brandAccentLight"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  },
  {
    ...
    link: "https://www.linkedin.com/in/felix-tian",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
