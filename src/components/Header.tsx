    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          <Link
            href="/"
            className="text-xl sm:text-2xl md:hover:text-brandprimary dark:md:hover:text-funcaccent focus-visible:outline-brandprimary dark:focus-visible:outline-funcaccent"
          >
            SatNaing
            <span className="text-brandprimary dark:text-funcaccent">.dev</span>
          </Link>
          <nav className="flex items-center">
              ...
              <ul className="flex justify-evenly items-center py-1">
                {navLinks.map((navLink) => (
                  <li key={navLink.url}>
                    <a
                      href={navLink.url}
                      className={`text-sm md:text-lg flex flex-col items-center w-[4.5rem] md:w-auto dark:fill-textlight md:mr-6 md:hover:text-brandprimary md:dark:hover:text-funcaccent link-outline ${
                        currentSection === navLink.text.toLocaleLowerCase() &&
                        'text-brandprimary dark:text-funcaccent fill-brandprimary dark:fill-funcaccent'
                      }`}
                    >
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className="fill-textlight hidden dark:inline-block transform scale-110 md:dark:hover:fill-funcaccent"
              >
